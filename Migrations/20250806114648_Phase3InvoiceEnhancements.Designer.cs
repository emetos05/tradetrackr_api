...
namespace tradetrackr.api.Migrations
{
    ...
    [Migration("20250806114648_Phase3InvoiceEnhancements")]
    partial class Phase3InvoiceEnhancements
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "invoice_status", new[] { "draft", "sent", "paid", "overdue", "cancelled" });
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "job_status", new[] { "not_started", "in_progress", "completed", "cancelled", "on_hold" });
